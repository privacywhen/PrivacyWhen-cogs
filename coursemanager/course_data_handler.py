...
class CourseDataHandler(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.config.register_guild(cog_enabled=False)
    ...
    async def get_cog_enabled(self, guild: Guild) -> bool:
        return await self.config.guild(guild).cog_enabled()

    async def set_cog_enabled(self, guild: Guild, value: bool) -> None:
        await self.config.guild(guild).cog_enabled.set(value)
